...
|--------|---------|--------|----------|
| **Reveal** | v0.100.2 | In production | 62K+ downloads, ~5K/month (PyPI) |
...
- All architecture documented publicly
- Production systems open source
- Research published openly
- Agent contributions acknowledged with provenance
...
**Read our research:**
- [Essays](/essays/progressive-disclosure-for-ai-agents) — technical essays on semantic infrastructure
