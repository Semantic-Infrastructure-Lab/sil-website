...
**[Reveal](https://github.com/Semantic-Infrastructure-Lab/reveal)** — Progressive code exploration with 10-150x token reduction. Structure before content. Meaning before noise. `pip install reveal-cli`

**[Morphogen](https://github.com/Semantic-Infrastructure-Lab/morphogen)** — Cross-domain deterministic computation. 40+ domains. Bitwise reproducibility. Cryptographic provenance.

**[GenesisGraph](https://github.com/Semantic-Infrastructure-Lab/genesisgraph)** — Verifiable provenance with selective disclosure. Every transformation produces a record.

**[TiaCAD](https://github.com/Semantic-Infrastructure-Lab/tiacad)** — Parametric CAD in YAML. Semantic constraints, not just geometry. Proof that these principles work beyond code.
...
- [Founder's Letter](/foundations/founders-letter) — The personal why
