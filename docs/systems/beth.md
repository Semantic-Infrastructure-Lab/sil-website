...
**Architecture:**
- [Semantic OS Architecture](/foundations/semantic-os-architecture) - Where Beth fits in the 7-layer stack
- [Unified Architecture Guide](/architecture/unified-architecture-guide) - Complete system design
...
**Philosophy:**
- [Founder's Letter](/foundations/founders-letter) - Glass-box laboratory principles
