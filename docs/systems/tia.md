...
**Architecture:**
- [Semantic OS Architecture](/foundations/SIL_SEMANTIC_OS_ARCHITECTURE.md) - Where Tia fits in the 7-layer stack
- [Agent Ether](/systems/AGENT_ETHER.md) - Multi-agent coordination principles informed by Tia's patterns

**Companion Systems:**
- [Beth](./BETH.md) - Knowledge substrate that Tia queries
- [Reveal](./REVEAL.md) - Progressive disclosure tool that Tia uses daily

**Philosophy:**
- [Founder's Letter](/foundations/FOUNDERS_LETTER.md) - Scott + Tia collaboration explained
- [Design Principles](/foundations/SIL_PRINCIPLES.md) - Principles validated through Tia's use
