...
**Related Document:** For foundational architectural constraints, see [SIL Principles](/foundations/design-principles) which defines the 14 theoretical principles governing the Semantic OS architecture.
...
- [Hierarchical Agency Framework](/research/hierarchical-agency-framework) - Section 10.1 applies this principle to multi-agent orchestration
...
**Core Architecture**:
- [Project Index](/projects/project-index) - All 12 projects mapped
- [Unified Architecture Guide](/architecture/unified-architecture-guide) - Semantic OS architecture

**Quality & Safety**:
- [Safety Thresholds](/meta/safety-thresholds) - Risk classification and thresholds
